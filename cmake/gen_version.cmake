...
if(EXISTS ${CUBRID_JDBC_OUTPUT_DIR}/VERSION-DIST AND NOT EXISTS ${CUBRID_JDBC_SOURCE_DIR}/VERSION)

    # set CUBRID_JDBC_RELEASE_VERSION from existing VERSION-DIST
    file(STRINGS ${CUBRID_JDBC_OUTPUT_DIR}/VERSION-DIST CUBRID_JDBC_RELEASE_VERSION)

else(EXISTS ${CUBRID_JDBC_OUTPUT_DIR}/VERSION-DIST AND NOT EXISTS ${CUBRID_JDBC_SOURCE_DIR}/VERSION)
...
endif(EXISTS ${CUBRID_JDBC_OUTPUT_DIR}/VERSION-DIST AND NOT EXISTS ${CUBRID_JDBC_SOURCE_DIR}/VERSION)
